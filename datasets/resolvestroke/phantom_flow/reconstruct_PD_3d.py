...
Flow-phantom (CIRS 769 + ATS523A) CEUS acquisition, five 1 s clips of a bolus
wash-in through two tubes.
...
# --- Inputs -----------------------------------------------------------------
# Defaults stream straight from the published corpus. Swap INPUT for a local path to
