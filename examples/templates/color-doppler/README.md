...
_One short paragraph describing the data: acquisition modality (color Doppler), anatomy (e.g. carotid, cardiac), task focus, and intended research contribution. State whether data is clinical, phantom, simulated, or in vivo animal._
...
_e.g. Blood flow estimation, Doppler beamforming, clutter filtering._
...
- **Samples / frames:** _e.g. 200 ensembles across 5 subjects_
- **Train / val / test split:** _e.g. 70 / 15 / 15 % (or N/A)_
- **Total size on disk:** _e.g. 8 GB_
...
| `velocity_map.values` | `(N_frames, H, W, 1)` | float32 | m/s | Estimated velocity map |
