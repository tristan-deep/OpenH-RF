...
from network_ops import inference
...
def main():
    ...
    # if args.load_config:
    if False: # TODO: need to fix writing first
        ...
        pipeline = Pipeline(operations=[
            ...
            Lambda(inference, key='data', output_key='data'),
            Normalize(input_range=(-1, 1), output_range=(1300, 3600))
        ])

    # TODO: need to find a way to serialize the Lambda operation
    ...
    print(f"Reconstructed: {outputs.shape}")
