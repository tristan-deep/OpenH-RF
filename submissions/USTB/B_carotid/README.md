...
- **Total size on disk:** 396 MB

Per-acquisition summary:

| Acquisition | frames | transmits | samples | elements | n_ch | fs (MHz) | fc (MHz) | size (MB) |
|---|---|---|---|---|---|---|---|---|
| `L7_FI_carotid_cross_1` | 2 | 128 | 1920 | 128 | 1 | 20.8 | 5.21 | 141 |
| `L7_FI_carotid_cross_2` | 2 | 128 | 1920 | 128 | 1 | 20.8 | 5.21 | 127 |
| `L7_FI_carotid_cross_sub_2` | 2 | 128 | 1920 | 128 | 1 | 20.8 | 5.21 | 128 |
